...
def seed_homes():
    ...
    home2 = Home(price = 1000000, stAddress = "1537 Park Street", city = "Brentwood", state = "CA", zipCode = 94513, latitude = 37.93249, longitude = -121.69218, lotSize = 3200, beds = 4, bath = 2.5, status = "For Rent",userId='2')
    ...
    home5 = Home(price = 850000, stAddress = "1505 Alexander Avenue", city = "Brentwood", state = "CA", zipCode = 94513, latitude = 38.006211594551, longitude = -121.859342026557, lotSize = 2600, beds = 4, bath = 2.5, status = "For Rent",userId='2')
    ...
    home7 = Home(price = 700000, stAddress = "200 Griffith Ln.", city = "Brentwood", state = "CA", zipCode = 94513, latitude = 37.9294572258095, longitude = -121.70755693297, lotSize = 2000, beds = 4, bath = 2.5, status = "For Rent",userId='1')
    ...
    home10 = Home(price = 550000, stAddress = "6651 Lone Tree Way	", city = "Brentwood", state = "CA", zipCode = 94513, latitude = 37.9628145530703, longitude = -121.730503024968, lotSize = 1400, beds = 4, bath = 2.5, status = "For Rent",userId='1')
    ...
    home13 = Home(price = 950000, stAddress = "180 Hemme Ave.", city = "Alamo", state = "CA", zipCode = 94507, latitude = 37.8419380048982, longitude = -122.028706451038, lotSize = 3000, beds = 4, bath = 2.5, status = "For Rent",userId='1')
    ...
    home17 = Home(price = 900000, stAddress = "218 Ray St", city = "Pleasenton", state = "CA", zipCode = 94566, latitude = 37.6643927538384, longitude = -121.872735118422, lotSize = 2800, beds = 4, bath = 2.5, status = "For Rent",userId='1')
    ...
    home20 = Home(price = 700000, stAddress = "25800 Carlos Bee Blvd", city = "Hyward", state = "CA", zipCode = 94542, latitude = 37.6599135526149, longitude = -122.057053551656, lotSize = 2000, beds = 4, bath = 2.5, status = "For Rent",userId='1')
    ...
    home24 = Home(price = 950000, stAddress = "538 Vineyard Drive", city = "San Francisco", state = "CA", zipCode = 94117, latitude = 37.8040782986359, longitude = -122.410628402489, lotSize = 3000, beds = 4, bath = 2.5, status = "For Rent",userId='1')
