...
def seed_homes():
    ...
    home2 = Home(price = 1000000, stAddress = "1537 Park Street", city = "Brentwood", state = "CA", zipCode = 94513, latitude = 37.93249, longitude = -121.69218, lotSize = 3200, beds = 4, bath = 2.5, status = "Rent",userId=1)
    ...
    home4 = Home(price = 900000, stAddress = "1258 Nelm Street", city = "Brentwood", state = "CA", zipCode = 94513, latitude = 37.9312285992078, longitude = -121.691996556812, lotSize = 2800, beds = 2, bath = 1, status = "For sale",userId=1)
